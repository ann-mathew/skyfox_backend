...
class MovieServiceResponseTest {
    ...
    public void should_convert_to_a_movie_with_valid_runtime() throws FormatException {
        final var movieServiceResponse = new MovieServiceResponse("id", "title", "50 min", "plot", "poster");

        final var actualMovie = movieServiceResponse.toMovie();

        final var expectedMovie = new Movie("id", "title", Duration.ofMinutes(50), "plot", "poster");
    ...
    public void should_not_convert_to_a_movie_with_invalid_runtime(String runtime) {
        final var movieServiceResponse = new MovieServiceResponse("id", "title", runtime, "plot", "poster");
